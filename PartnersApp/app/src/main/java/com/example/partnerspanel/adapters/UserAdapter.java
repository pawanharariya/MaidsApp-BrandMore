...
public class UserAdapter extends ArrayAdapter {
    ...
    private void getCustomerLocation(String customerId) {
        ...
        //TODO changes here for customerDid
        DocumentReference location = db.collection("/customerPanel/locations/currentLocations/").document("firebaseId10");
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                } else Toast.makeText(getContext(), "No location shown", Toast.LENGTH_SHORT).show();
            }
        }, 3000);
    }
}
